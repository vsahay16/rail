...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og.jpg", width: 1200, height: 630, alt: "RailQ — Every railway answer. One simple journey." }],
  },
    ...
    <html lang={initialLanguage === "hi" ? "hi-IN" : "en-IN"}>
      <body>
        <StructuredData data={{
          ...
          "@graph": [
            { "@type": "Organization", "@id": `${siteUrl}/#organization`, name: "RailQ", url: siteUrl, logo: `${siteUrl}/favicon.svg` },
            { "@type": "WebSite", "@id": `${siteUrl}/#website`, url: siteUrl, name: "RailQ", inLanguage: ["en-IN", "hi-IN"], publisher: { "@id": `${siteUrl}/#organization` } },
          ],
        }} />
