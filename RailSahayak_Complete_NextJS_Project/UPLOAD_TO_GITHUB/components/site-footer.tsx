...
export function SiteFooter() {
  ...
  return <footer className="site-footer">
    ...
    <div className="footer-links">
      ...
      <div><b>{hi ? "जानकारी" : "Resources"}</b><Link href="/railway-updates">{hi ? "रेलवे नियम अपडेट" : "Railway rule updates"}</Link><Link href="/guides">{hi ? "यात्रा गाइड" : "Travel guides"}</Link><Link href="/blog">{hi ? "ब्लॉग" : "Blog"}</Link><Link href="/about">{hi ? "हमारे बारे में" : "About RailQ"}</Link><Link href="/contact">{hi ? "संपर्क करें" : "Contact us"}</Link></div>
    ...
    <div className="footer-bottom"><span>© 2026 RailQ</span><p>{hi ? "RailQ भारतीय रेल या IRCTC से संबद्ध नहीं है। अंतिम और महत्वपूर्ण जानकारी हमेशा आधिकारिक रेलवे माध्यम से सत्यापित करें।" : "RailQ is not affiliated with Indian Railways or IRCTC. Always verify critical and final journey information through official railway channels."}</p></div>
  </footer>;
}
