...
export const toolConfigs: ToolConfig[] = [
  ...
  { slug: "pnr-alerts", icon: "bell", category: "live", title: "PNR Change Alerts", titleHi: "PNR बदलाव अलर्ट", description: "Request privacy-aware rechecks and status-change notifications.", descriptionHi: "गोपनीयता के साथ PNR दोबारा जाँच और बदलाव सूचना पाएँ।", live: true },
